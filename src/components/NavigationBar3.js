...
const NavigationBar3 = ({ frame, dinMaegler, paperPlane11, call1, user41 }) => {
  ...
  return (
    <div className="absolute top-[5px] left-[0px] flex flex-col items-center justify-center text-left text-2xl text-gray-1600 font-roboto">
