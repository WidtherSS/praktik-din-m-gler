...
const NavigationBar4 = () => {
  ...
  return (
    <div className="absolute top-[5px] left-[-1px] flex flex-col items-center justify-center text-left text-2xl text-gray-1600 font-roboto">
      <div className="relative w-[1920px] h-[147px] shrink-0">
        <div className="absolute top-[62px] left-[0px] bg-white w-[1920px] flex flex-row p-[18px_405px] box-border items-center justify-between">
          ...
          <img
            ...
            alt=""
            src="../din-maegler15.svg"
          />
          <div className="flex flex-row items-center justify-center gap-[65px] text-base text-gray-1400">
            ...
            <div className="relative w-[583px] h-[30px] shrink-0 md:hidden">
              ...
              <Link
                className="cursor-pointer [text-decoration:none] absolute top-[0px] left-[179px] leading-[30px] text-[inherit] inline-block"
                to="/agents-2"
              >
                Mæglere
              </Link>
              <Link
                className="cursor-pointer [text-decoration:none] absolute top-[0px] left-[315px] leading-[30px] text-[inherit] inline-block"
                to="/favorites"
              >
                Mine favoritter
              </Link>
              <a className="[text-decoration:none] absolute top-[0px] left-[497px] leading-[30px] text-[inherit] inline-block">
                Kontakt os
              </a>
            </div>
          </div>
