...
const NavigationBar5 = () => {
  ...
  return (
    <div className="absolute top-[0px] left-[0px] flex flex-col items-center justify-center text-left text-2xl text-gray-1600 font-roboto">
