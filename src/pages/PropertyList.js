...
const PropertyList = () => {
  return (
    <section className="relative bg-white w-full h-[3531px] overflow-hidden text-left text-base text-gray-1400 font-roboto">
      <BG />
      <Banner />
      <Search />
      <div className="absolute top-[2654px] left-[0px] w-[1920px] h-[877px] overflow-hidden">
        ...
        <div className="absolute top-[273px] left-[975px] w-[255px] h-[208px] text-xl text-gray-1600">
          ...
          <a className="[text-decoration:none] absolute top-[48px] left-[0px] text-base leading-[40px] text-gray-1400 inline-block w-[255px]">
